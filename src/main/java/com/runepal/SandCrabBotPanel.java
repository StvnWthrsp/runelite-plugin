...
public class SandCrabBotPanel extends PluginPanel {
    ...
    private final JTextField foodTypeField;
    private final JSpinner foodQuantitySpinner;
    private final JTextField potionTypeField;
    ...
    public SandCrabBotPanel(RunepalPlugin plugin, BotConfig config, ConfigManager configManager) {
        ...
        this.foodTypeField = new JTextField(config.sandCrabFood(), 15);
        this.foodQuantitySpinner = new JSpinner(new SpinnerNumberModel(config.sandCrabFoodQuantity(), 0, 28, 1));
        this.potionTypeField = new JTextField(config.sandCrabPotion(), 15);
    ...
    private JPanel createConfigurationPanel() {
        ...
        foodTypeField.setToolTipText("Type of food to use (e.g., COOKED_KARAMBWAN, LOBSTER)");
        configPanel.add(foodTypeField, gbc);
        ...
        gbc.gridx = 1; gbc.fill = GridBagConstraints.HORIZONTAL;
        potionTypeField.setToolTipText("Type of potion to use (e.g., SUPER_COMBAT, SUPER_STRENGTH)");
        configPanel.add(potionTypeField, gbc);
        ...
        foodTypeField.addActionListener(e -> saveConfiguration());
        foodTypeField.addFocusListener(new java.awt.event.FocusAdapter() {
        ...
        potionTypeField.addActionListener(e -> saveConfiguration());
        potionTypeField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent e) {
                saveConfiguration();
            }
        });
    ...
    private void saveConfiguration() {
        configManager.setConfiguration("runepal", "sandCrabFood", foodTypeField.getText());
        configManager.setConfiguration("runepal", "sandCrabFoodQuantity", (Integer) foodQuantitySpinner.getValue());
        configManager.setConfiguration("runepal", "sandCrabPotion", potionTypeField.getText());
    ...
    private void loadConfigurationValues() {
        foodTypeField.setText(config.sandCrabFood());
        foodQuantitySpinner.setValue(config.sandCrabFoodQuantity());
        potionTypeField.setText(config.sandCrabPotion());
