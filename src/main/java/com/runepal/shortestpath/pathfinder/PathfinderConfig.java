...
import com.runepal.shortestpath.Destination;
import com.runepal.shortestpath.PrimitiveIntHashMap;
import com.runepal.shortestpath.Transport;
import com.runepal.shortestpath.TransportItems;
import com.runepal.shortestpath.TransportType;
import com.runepal.shortestpath.TransportVarbit;
import com.runepal.shortestpath.TransportVarPlayer;
import com.runepal.shortestpath.WorldPointUtil;

import static com.runepal.shortestpath.TransportType.AGILITY_SHORTCUT;
import static com.runepal.shortestpath.TransportType.GRAPPLE_SHORTCUT;
import static com.runepal.shortestpath.TransportType.BOAT;
import static com.runepal.shortestpath.TransportType.CANOE;
import static com.runepal.shortestpath.TransportType.CHARTER_SHIP;
import static com.runepal.shortestpath.TransportType.SHIP;
import static com.runepal.shortestpath.TransportType.FAIRY_RING;
import static com.runepal.shortestpath.TransportType.GNOME_GLIDER;
import static com.runepal.shortestpath.TransportType.HOT_AIR_BALLOON;
import static com.runepal.shortestpath.TransportType.MINECART;
import static com.runepal.shortestpath.TransportType.QUETZAL;
import static com.runepal.shortestpath.TransportType.SPIRIT_TREE;
import static com.runepal.shortestpath.TransportType.TELEPORTATION_LEVER;
import static com.runepal.shortestpath.TransportType.TELEPORTATION_MINIGAME;
import static com.runepal.shortestpath.TransportType.TELEPORTATION_PORTAL;
import static com.runepal.shortestpath.TransportType.TELEPORTATION_ITEM;
import static com.runepal.shortestpath.TransportType.TELEPORTATION_SPELL;
import static com.runepal.shortestpath.TransportType.WILDERNESS_OBELISK;
...
public class PathfinderConfig {
    ...
    public PathfinderConfig(Client client, BotConfig config) {
        this.client = client;
        this.config = config;
    ...
    public void refresh() {
        calculationCutoffMillis = config.spCalculationCutoff() * Constants.GAME_TICK_LENGTH;
        avoidWilderness = config.spAvoidWilderness();
        useAgilityShortcuts = config.spUseAgilityShortcuts();
        useGrappleShortcuts = config.spUseGrappleShortcuts();
        useBoats = config.spUseBoats();
        useCanoes = config.spUseCanoes();
        useCharterShips = config.spUseCharterShips();
        useShips = config.spUseShips();
        useFairyRings = config.spUseFairyRings();
        useGnomeGliders = config.spUseGnomeGliders();
        useHotAirBalloons = config.spUseHotAirBalloons();
        useMinecarts = config.spUseMinecarts();
        useQuetzals = config.spUseQuetzals();
        useSpiritTrees = config.spUseSpiritTrees();
        useTeleportationItems = config.spUseTeleportationItems();
        useTeleportationLevers = config.spUseTeleportationLevers();
        useTeleportationMinigames = config.spUseTeleportationMinigames();
        useTeleportationPortals = config.spUseTeleportationPortals();
        useTeleportationSpells = config.spUseTeleportationSpells();
        useWildernessObelisks = config.spUseWildernessObelisks();
        currencyThreshold = config.spCurrencyThreshold();
